    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if verify_status['verify_token'] != token:
                return await message.reply("<b>🔃 ʏᴏᴜʀ ᴛᴏᴋᴇɴ ɪꜱ ɪɴᴠᴀʟɪᴅ ᴏʀ ᴇxᴘɪʀᴇᴅ. ᴛʀʏ ᴀɢᴀɪɴ ʙʏ ᴄʟɪᴄᴋɪɴɢ /start</b>")
            await update_verify_status(id, is_verified=True, verified_time=time.time())
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"<b>✅ ʏᴏᴜʀ ᴛᴏᴋᴇɴ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴠᴇʀɪꜰɪᴇᴅ ᴀɴᴅ ᴠᴀʟɪᴅ ꜰᴏʀ: 24 ʜᴏᴜʀ⏳\n\n📌ᴛᴜᴍʜᴀʀᴀ ᴛᴏᴋᴇɴ ᴠᴇʀɪꜰʏ ʜᴏɢᴀʏᴀ ʜᴀɪ ᴀʙ ᴠᴀᴘɪꜱ ᴄʜᴀɴɴᴇʟ ᴍᴇ ᴊᴀᴋᴇ ʟɪɴᴋ ᴍᴇ ᴄʟɪᴄᴋ ᴋᴀʀᴏ📌</b>", reply_markup=reply_markup, protect_content=False, quote=True)
