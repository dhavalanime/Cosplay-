...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002471587665"))
...
SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "short2url.in")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "ce843a90d0fca44a46211779e2c312b61dac1462")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID", "https://t.me/How_to_download_ST/7") # shareus ka tut_vid he 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002414908388"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6692613520 7475464684").split()):
        ADMINS.append(int(x))
except ValueError:
